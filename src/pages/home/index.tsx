    ...
    <div>
        ...
        <CardSkonpMobile>
            <CardSkonpTextHeader>skonp</CardSkonpTextHeader>
                ...
                <BtnAllPrjects onClick={()=>{navigation('/projects')}}>SVI PROJEKTI</BtnAllPrjects>
            </CardSkonpMobile>
        </CardSkonpWrapper>
        <Line/>
        <PrevFooter>
